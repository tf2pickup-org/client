...
describe('AcceptRulesDialogComponent', () => {
  ...
  it('should render the mumble confirmation button', () => {
    expect(
      fixture.debugElement.query(By.css('.confirm-mumble-button'))
        .nativeElement,
    ).toBeTruthy();
  });
  ...
  describe('when the user confirms mumble', () => {
    ...
    it('should render the accept rules button', () => {
      expect(
        fixture.debugElement.query(By.css('.accept-rules-button'))
          .nativeElement,
      ).toBeTruthy();
    });
