import { gameServersLoaded, gameServerByName, gameServerById } from './game-servers.selectors';
...
describe('game servers selectors', () => {
  ...
  describe('gameServerByName', () => {
    it('should find the game server', () => {
      expect(gameServerByName('FAKE_NAME').projector([
  ...
  describe('gameServerById', () => {
    it('should select the game server by id', () => {
      expect(gameServerById('2').projector({
