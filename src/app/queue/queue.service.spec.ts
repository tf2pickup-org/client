...
describe('QueueService', () => {
    ...
    it('should call the endpoint', inject(
      ...
      (service: QueueService) => {
        ...
        const request = httpController.expectOne(
          'FAKE_URL/queue/map_vote_results/scramble',
        ).request;
  ...
  describe('#joinQueue()', () => {
    it('should call the endpoint', inject(
      ...
      (service: QueueService) => {
        ...
        expect(socketStub.call).toHaveBeenCalledWith('join queue', {
          slotId: 11,
        });
      },
    ));
  ...
  describe('#voteForMap()', () => {
    it('should call the endpoint', inject(
      ...
      (service: QueueService) => {
        ...
        expect(socketStub.call).toHaveBeenCalledWith('vote for map', {
          map: 'cp_fake_rc1',
        });
      },
    ));
  ...
  describe('#markFriend()', () => {
    it('should call the endpoint', inject(
      ...
      (service: QueueService) => {
        ...
        expect(socketStub.call).toHaveBeenCalledWith('mark friend', {
          friendPlayerId: 'FAKE_ID',
        });
      },
    ));
  });
  ...
  describe('#setMaps()', () => {
    it('should call the endpoint', inject(
      ...
      (service: QueueService) => {
        service
          .setMaps([{ name: 'cp_process_final', execConfig: 'etf2l_6v6_5cp' }])
          .subscribe();
